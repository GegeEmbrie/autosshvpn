...
curl -s http://autoscript.kepalatupai.com/file/vpnserver2 > /etc/init.d/vpnserver
chmod 755 /etc/init.d/vpnserver
curl -s http://autoscript.kepalatupai.com/file/ipv4_forwarding.conf  > /etc/sysctl.d/ipv4_forwarding.conf
sysctl --system
